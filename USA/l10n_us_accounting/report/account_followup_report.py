...
class FollowUpReportUSA(models.AbstractModel):
    ...
    def _get_summary_lines(self, options):
        ...
        for line in partner.unreconciled_aml_ids.filtered(lambda line: line.company_id == self.env.company):
        ...
        for currency, aml_recs in res.items():
            ...
            lines.append({
                ...
                'unfoldable': False,
                'level': 0,
                'columns': [{"name": values[key][1]} for key in values]
            })
